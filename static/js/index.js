$(function(){
    ...
    //侧导航
    let vip=$('.mui-mbar-tab-prof .logo')
    let money=$('.mui-mbar-tab-asset .logo')
    let shouc=$('.mui-mbar-tab-favor .logo')
    let isee=$('.mui-mbar-tab-foot .logo')
    let cz=$('.mui-mbar-tab-charge .logo')
    let top=$('.mui-mbar-tab-top .logo')
    let fk=$('.mui-mbar-tab-ue .logo')
    function aside(item){
        item.mouseenter(function(){
            item.css({
                background: '#ff0036',
            })
            item.parent().find('.tips').css({
                right: '35px',
                transition: 'all .6s',
                opacity: 1,
            })
